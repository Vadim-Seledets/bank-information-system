        ...
        <div className={css.properties} style={{ ...dim(2, 2, 11, 12) }}>
          {creatingDeposit && (
            <React.Fragment>
              ...
              <select style={{ ...dim(3, 2, 3, 2) }} className={commonCss.input} value={creatingDeposit.depositTypeId}
              ...
              <input style={{ ...dim(3, 3, 3, 3) }} className={commonCss.input} disabled={true} type="text" value={creatingDeposit.contractNumber}
              ...
              <input style={{ ...dim(3, 4, 3, 4) }} className={commonCss.input} type="date" defaultValue={creatingDeposit.programStartDate}
              ...
              <input style={{ ...dim(3, 5, 3, 5) }} className={commonCss.input} type="date" defaultValue={creatingDeposit.programEndDate}
              ...
              <input style={{ ...dim(3, 6, 3, 6) }} className={commonCss.input} type="date" defaultValue={creatingDeposit.contractValidUntil}
              ...
              <select style={{ ...dim(3, 7, 3, 7) }} className={commonCss.input} value={creatingDeposit.customerId}
              ...
              <input style={{ ...dim(3, 9, 3, 9) }} className={commonCss.input} type="number" max={1} min={0} step={0.001} defaultValue={creatingDeposit.rate}
