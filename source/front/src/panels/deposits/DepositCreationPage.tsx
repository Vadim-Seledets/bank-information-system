        ...
        <div className={css.properties} style={{ ...dim(2, 2, 11, 12) }}>
          ...
          <div className={css.property}>
            ...
            <select className='propertyInputColumn' style={{ height: 'auto', marginTop: '0.3em' }} value={creatingDeposit.depositTypeId}
              is-invalid={`${!p.depositsPage.depositCreationPage.validation.isValid('depositTypeId') || creatingDeposit.infoErrors.has('DepositTypeId')}`}
          ...
          <div className={css.property}>
            ...
            <input className={'propertyInputColumn'} type="date" value={creatingDeposit.programStartDate}
              is-invalid={`${!p.depositsPage.depositCreationPage.validation.isValid('programStartDate') || creatingDeposit.infoErrors.has('ProgramStartDate')}`}
          ...
          <div className={css.property}>
            ...
            <input className={'propertyInputColumn'} type="date" value={creatingDeposit.programEndDate}
              is-invalid={`${!p.depositsPage.depositCreationPage.validation.isValid('programEndDate') || creatingDeposit.infoErrors.has('ProgramEndDate')}`}
          ...
          <div className={css.property}>
            ...
            <input className={'propertyInputColumn'} type="date" value={creatingDeposit.contractValidUntil}
              is-invalid={`${!p.depositsPage.depositCreationPage.validation.isValid('contractValidUntil') || creatingDeposit.infoErrors.has('ContractValidUntil')}`}
          ...
          <div className={css.property}>
            ...
            <select className='propertyInputColumn' style={{ height: 'auto', marginTop: '0.3em' }} value={creatingDeposit.customerId}
              is-invalid={`${!p.depositsPage.depositCreationPage.validation.isValid('customerId') || creatingDeposit.infoErrors.has('CustomerId')}`}
          ...
          <div className={css.property}>
            ...
            <div className='propertyInputHorizontalLine'>
              <input className={'propertyInputColumn'} type="number" value={creatingDeposit.amount}
                is-invalid={`${!p.depositsPage.depositCreationPage.validation.isValid('amount') || creatingDeposit.infoErrors.has('Amount')}`}
            ...
            <div className={css.property}>
              ...
              <input className={'propertyInputColumn'} type="number" max={1} min={0} step={0.001} value={creatingDeposit.rate}
                is-invalid={`${!p.depositsPage.depositCreationPage.validation.isValid('rate') || creatingDeposit.infoErrors.has('Rate')}`}
