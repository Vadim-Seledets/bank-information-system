              ...
              <div className={css.transactions}>
                ...
                {depositDetailes.transactions.map((t, i) => (
                  <React.Fragment key={i}>
                    ...
                    <div style={{ ...dim(3, i + 2, 3, i + 2) }}>{`${t.amount} ${auxiliary.currencies.find(v => v.id === t.currencyId)?.code}`}</div>
                    <div style={{ ...dim(5, i + 2, 5, i + 2) }}>{t.senderAccountNumber}</div>
                    <div style={{ ...dim(6, i + 2, 6, i + 2) }} className='las la-long-arrow-alt-right' />
                    <div style={{ ...dim(7, i + 2, 7, i + 2) }}>{t.receiverAccountNumber}</div>
